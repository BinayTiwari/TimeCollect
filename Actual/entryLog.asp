...
<body class="main">
  ...
  <%
  	DIM arrAvailable
 	strSQL = "  SELECT  TC_EntryLog.EntryLogID, TC_EntryLog.[Date ], TC_EntryLog.userID, TC_EntryLog.[IPaddress ], TC_Sites.SiteName FROM TC_EntryLog INNER JOIN "&_
              " TC_Sites ON TC_EntryLog.SiteID = TC_Sites.SiteID ORDER BY EntryLogID"
