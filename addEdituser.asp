...
<body class="main">
  ...
  <%
  	DIM arrAvailable
 	strSQL = " SELECT TC_Users.UserID,TC_Users.Active, TC_Users.UserType, TC_Users.UserEmail, TC_Users.[UserPassword ], TC_Sites.SiteName, TC_Dept.[DeptName ] FROM  TC_Users INNER JOIN "&_
             " TC_Sites ON TC_Users.UserSiteID = TC_Sites.SiteID INNER JOIN TC_Dept ON TC_Users.UserDeptID = TC_Dept.DeptID ORDER BY SITEID"
